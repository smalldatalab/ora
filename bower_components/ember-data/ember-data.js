  ...
  function(__dependency1__, __exports__) {
    ...
    */
    ...
    /**
      ...
      ```
      Requests for `App.Person` would now target `/api/1/people.js/1`.
    ...
    __exports__["default"] = Adapter.extend({
      ...
      /**
        ...
        ```js
        {
          "person": {
            "id": 1,
            "name": "Tom Dale",
            "links": { "group": "/people.js/1/group" }
          }
        }
        ```

        This method will be called with the parent record and `/people.js/1/group`.
      ...
      */
      ...
      /**
        ...
        becomes 'posts' and 'person' becomes 'people.js'). To override the
      ...
      */
      ...
      /**
        ...
        'post' becomes 'posts' and 'person' becomes 'people.js').
    ...
    */
    __exports__["default"] = RecordArray.extend({
      /**
        ...
        var people.js = store.filter('person', function(person) {
          if (person.get('name').match(/Katz$/)) { return true; }
        });
        people.js.mapBy('name'); // ["Yehuda Katz"]

        var notKatzFilter = function(person) {
          return !person.get('name').match(/Katz$/);
        };
        people.js.set('filterFunction', notKatzFilter);
        people.js.mapBy('name'); // ["Tom Dale", "Trek Glowacki"]
        ```
    ...
    __exports__["default"] = Ember.ArrayProxy.extend(Ember.Evented, {
      ...
      */
      ...
      /**
        ...
        ```javascript
        var people.js = store.all('person');
        people.js.get('isLoaded'); // true
        ```
      ...
      */
      ...
      /**
        ...
        ```javascript
        var people.js = store.all('person');
        people.js.get('isUpdating'); // false
        people.js.update();
        people.js.get('isUpdating'); // true
        ```
